...
import net.veritran.token_services.digital_enablement.model.DeleteRequestSchema;
import net.veritran.token_services.digital_enablement.model.DeleteResponseSchema;
...
@Component("net.veritran.token_services.digital_enablement.api.DeleteApi")
public class DeleteApi {
     ...
     */
    public DeleteResponseSchema deleteDigitization(DeleteRequestSchema deleteRequestSchema) throws RestClientException {
        return deleteDigitizationWithHttpInfo(deleteRequestSchema).getBody();
    }
     ...
     * <p><b>500</b> - Example application error response 
     * @param deleteRequestSchema Contains the details of the request message.  (optional)
     * @return ResponseEntity&lt;DeleteResponseSchema&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<DeleteResponseSchema> deleteDigitizationWithHttpInfo(DeleteRequestSchema deleteRequestSchema) throws RestClientException {
        Object postBody = deleteRequestSchema;
        
        String path = UriComponentsBuilder.fromPath("/digitization/static/1/0/delete").build().toUriString();
        ...
        ParameterizedTypeReference<DeleteResponseSchema> returnType = new ParameterizedTypeReference<DeleteResponseSchema>() {};
