...
import net.veritran.token_services.digital_enablement.model.SearchTokensRequestSchema;
import net.veritran.token_services.digital_enablement.model.SearchTokensResponseSchema;
...
@Component("net.veritran.token_services.digital_enablement.api.SearchTokensApi")
public class SearchTokensApi {
     ...
     */
    public SearchTokensResponseSchema searchTokens(SearchTokensRequestSchema searchTokensRequestSchema) throws RestClientException {
        return searchTokensWithHttpInfo(searchTokensRequestSchema).getBody();
    }
     ...
     * <p><b>500</b> - Example application error response 
     * @param searchTokensRequestSchema Contains the details of the request message.  (optional)
     * @return ResponseEntity&lt;SearchTokensResponseSchema&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<SearchTokensResponseSchema> searchTokensWithHttpInfo(SearchTokensRequestSchema searchTokensRequestSchema) throws RestClientException {
        Object postBody = searchTokensRequestSchema;
        
        String path = UriComponentsBuilder.fromPath("/digitization/static/1/0/searchTokens").build().toUriString();
        ...
        ParameterizedTypeReference<SearchTokensResponseSchema> returnType = new ParameterizedTypeReference<SearchTokensResponseSchema>() {};
