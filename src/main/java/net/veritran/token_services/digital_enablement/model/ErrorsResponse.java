...
import net.veritran.token_services.digital_enablement.model.Error;
...
public class ErrorsResponse {
  ...
  **/
   ...
   * @return errors
  **/
  @ApiModelProperty(value = "__CONDITIONAL__ <br>Returned if one or more errors occurred performing the operation. Not present Get Token error conditions. ")
