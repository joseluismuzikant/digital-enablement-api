...
public class TokenDetailData {
  ...
  **/
  @ApiModelProperty(value = "Account holder information. Present in tokenize response if supported by the Token Requestor, if using a pushAccountReceipt and if there is account holder data associated with the push account receipt in case that the issuer decision is APPROVED.. ")
