...
import net.veritran.token_services.digital_enablement.model.DecisioningData;
...
public class TokenizeRequestSchema {
  ...
  **/
  @ApiModelProperty(required = true, value = "Contains the information of the funding account to be tokenized. <br>   __Note:__ fundingAccountInfo replaces cardInfo from previous versions.   ")
