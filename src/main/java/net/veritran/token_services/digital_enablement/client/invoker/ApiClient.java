package net.veritran.token_services.digital_enablement.client.invoker;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.datatype.threetenbp.ThreeTenModule;
import com.mastercard.developer.utils.AuthenticationUtils;
import net.veritran.token_services.digital_enablement.client.invoker.auth.ApiKeyAuth;
import net.veritran.token_services.digital_enablement.client.invoker.auth.Authentication;
import net.veritran.token_services.digital_enablement.client.invoker.auth.HttpBasicAuth;
import net.veritran.token_services.digital_enablement.client.invoker.auth.OAuth;
...
@Component("net.veritran.token_services.digital_enablement.client.invoker.ApiClient")
public class ApiClient {
    ...
    private String basePath = "http://sandbox.api.mastercard.com/xxxx";
    private String keyalias = "keyalias";
    private String keystorepassword = "keystorepassword";
    private String pkcs12KeyFilePath = "pkcs12KeyFilePath";
    ...
    public ApiClient(String propertiesPath) {
    ...
    public <T> ResponseEntity<T> invokeAPI(String path, HttpMethod method, MultiValueMap<String, String> queryParams, Object body, HttpHeaders headerParams, MultiValueMap<String, Object> formParams, List<MediaType> accept, MediaType contentType, String[] authNames, ParameterizedTypeReference<T> returnType) throws RestClientException {
        ...
        try {
            PrivateKey signingKey = AuthenticationUtils.loadSigningKey(
                    this.pkcs12KeyFilePath,
                    this.keyalias,
                    this.keystorepassword);
            Charset charset = StandardCharsets.UTF_8;
            String authHeader = com.mastercard.developer.oauth.OAuth.getAuthorizationHeader(requestBuilder.build().getUrl(),
                    method.toString(),
                    body !=null?new ObjectMapper().writeValueAsString(body):"",
                    charset,
                    this.consumerKey, signingKey);
            this.addDefaultHeader("Authorization", authHeader);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        /*End Auth1.0 integration*/
    ...
    private void loadApplicationProperties()  {
        ...
        try {
            reader = new FileReader(this.propertiesPath);
            Properties prop = new Properties();
            prop.load(reader);
            this.basePath = prop.getProperty("api_client.base_path");
            this.keyalias= prop.getProperty("api_client.keyalias");
            this.keystorepassword= prop.getProperty("api_client.keystorepassword");
            this.pkcs12KeyFilePath = prop.getProperty("api_client.pkcs12KeyFilePath");
            this.consumerKey = prop.getProperty("api_client.consumerKey");
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
