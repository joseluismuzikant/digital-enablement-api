 ...
 */
public class SuspendApiTest extends DigitalEnablementTest {

    private final SuspendApi api = new SuspendApi(super.getApi());
    ...
    public void createSuspendTest() {
        try {
            SuspendRequestSchema suspendRequestSchema = new ObjectMapper().readValue(new File("src/test/resources/json/Suspend.json"), SuspendRequestSchema.class);
