 ...
 */
public class UnsuspendApiTest extends DigitalEnablementTest {

    private final UnsuspendApi api = new UnsuspendApi(super.getApi());
    ...
    public void createUnsuspendTest() {
        try {
            UnSuspendRequestSchema unsuspendRequestSchema = new ObjectMapper().readValue(new File("src/test/resources/json/UnSuspend.json"), UnSuspendRequestSchema.class);
