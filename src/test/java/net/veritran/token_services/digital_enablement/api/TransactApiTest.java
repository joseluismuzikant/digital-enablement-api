 ...
 */
public class TransactApiTest extends DigitalEnablementTest {

    private final TransactApi api = new TransactApi(super.getApi());
    ...
    public void createTransactTest() {
        try {
            TransactRequestSchema transactRequestSchema = new ObjectMapper().readValue(new File("src/test/resources/json/Transact.json"), TransactRequestSchema.class);
            TransactResponseSchema response = api.createTransact(transactRequestSchema);
            Assert.assertEquals(response.getResponseHost(), "stl.services.mastercard.com/mdes");
        } catch (Exception e) {
